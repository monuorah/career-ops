...
**Cross-cutting advantage**: Frame the candidate's profile as a **"Technical builder"** who adapts framing to the role:
...
**IMPORTANT:** The TSV column order has status BEFORE score (col 5=status, col 6=score). In applications.md the order is reversed (col 5=score, col 6=status). merge-tracker.mjs handles the conversion.
